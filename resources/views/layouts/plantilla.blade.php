...
<body>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
        <div class="container"><a class="navbar-brand" href="{{url('/')}}">Consultorio</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mr-auto">
                    {{-- <li class="nav-item"><a class="nav-link" href="{{url('/perfil')}}">Perfil</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{url('/horas')}}">Ingresar hora</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{url('/ayudas')}}">Solicitar ayuda</a></li> --}}
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <a class="dropdown-item" href="{{url('/horas')}}">Ingresar hora</a>
                          <div class="dropdown-divider"></div>
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="{{url('/respuestas')}}">Asistencia pacientes</a>
                        </div>
                      </li>
